...
<body>
                    ...
                    <div class="container">
                        <div class="nav-header">
                            ...
                            <ul class="sf-menu" id="fh5co-primary-menu">
                                    <li><a  href="portal_residen.php">Halaman Utama</a></li>
                                  
                                    <li>
                                        <a href="#" class="fh5co-sub-ddown">Tempahan</a>
                                        <ul class="fh5co-sub-menu">
                                        <li><a class="active" href="reservation_residen.php">Senarai Tempahan</a></li>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="reservation_residen.php" method="POST">
 ...
 <?php
                    if ($row['status']=='Lulus'){
                        ?>
                        <a href="transaction_residen.php?rid=<?php echo $row['reserve_id']; ?>"target="blank"><img src="images\pay.jpg" height="50px"></a>
                        <?php
                    }
                    else{
                        ?>N/A<?php
...
<!---------------------------------------button delete trigger---------------------------------------------->
                    <a  href="reservation_residen.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
