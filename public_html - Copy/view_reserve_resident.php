    ...
    <?php
        ...
        if(isset($_POST['searchValue'])){    // Search activity
            ...
            if($term != ""){    // term is specified
                ...
                AND r.role='resident'
                AND r.status NOT IN ('Dalam Permohonan')
            ...
            if($num > 0){
                ...
                if($row['status'] == 'Batal'){
                    ...
                    echo "</td>";?>
                      <td>
                    <a  href="view_reserve_resident.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
                ...
                ?>
                      ...
                      if(isset($_GET['delete'])){    
                        ...
                        echo "location = 'view_reserve_resident.php'";
                        echo "</script>";
