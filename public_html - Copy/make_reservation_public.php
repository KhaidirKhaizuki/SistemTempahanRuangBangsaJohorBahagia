...
<body>
                        ...
                        <div class="nav-header">
                            ...
                            <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li>
                                        ...
                                        <li><a href="reserve_history public.php">Sejarah Tempahan</a></li>
 ...
 <br>
                        ...
                        if(isset($_GET['sid'])){ // Get details of the particular space
                            ...
                            $name = $description = $category = $block = $capacity = $price_public = $filepath =  "";
                            $name = $row['name'];
...
<?php
                    echo "<br>";
                           ...
                           echo "<div><h4>Kadar &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp RM ".$row['price_public']." sehari </h4></div>";
                            echo"<hr>";
                            ...
                            echo "<div><img src='" . $row["filepath"] . "'height='200' width='300'></div>";?>
...
<!-------------------------------------------RIGHT LAYOUT--------------------------------------------->
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="box_2">
                                ...
                                <form action="make_reservation_public.php" method="POST">
       ...
       $arr = mysqli_fetch_assoc($fetchPublic);
        ...
        if($startD > $endD){    // Cannot tolerate if end_date is earlier than start_date
            ...
            $insert = "INSERT INTO reservation( space_id, email, fullname, telno, role, tujuan, start_date, start_time, end_date, end_time,status, komen) VALUES ('$space_id','$email','$fullname','$telno','$role','$tujuan','$startD','$startT','$endD','$endT','Dalam Permohonan','')";
            ...
            if($result2){
                ...
                echo "location = 'portal_public.php'";
                echo "</script>";
            }
            else{
                echo "Failed";
