...
<?php
    ...
    if(isset($_POST['submit'])){ // If submit button is triggered,
        ...
        $updateA = "UPDATE account SET position='$position' WHERE email='$email'";
        $updateEXE = mysqli_query($conn, $updateA);

        if($updateEXE){
            echo "<script>";
            echo "alert('Butiran anda telah berjaya dikemaskini!');";
            echo "location = 'portal_admin.php'";
            echo "</script>";
        }
        else{
            echo "<script>";
...
<body>
						...
						<ul class="sf-menu" id="fh5co-primary-menu">
						 <li><a  href="portal_admin.php">Halaman Utama</a></li>
							...
							<li>
								...
								<ul class="fh5co-sub-menu">
								 	<li><a class ="active" href="kk_admin.php">Profil</a></li>
	...
	<!-- end:fh5co-header -->
	<div class="fh5co-parallax" style="background-image: url(images/bjb2.jpg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">KemasKini Informasi Akaun Admin</h1<br><br>
						<p>
			   				<a href="change_pwd_all.php" class="btn btn-primary btn-lg" style="color:black;">Tukar Kata Laluan</a>
			   			</p>
					</div>
				</div>
			</div>
	...
	<div id="fh5co-services-section">
		<div class="container">
			<div class="row">
			 <form method="POST" action="kk_admin.php">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="uname" value="<?php echo $_SESSION['email']; ?>" disabled></td>
                </tr>
                <tr>
                    <td><label>Nama Sebenar</label></td>
                    <td><input type="text" name="name" value="<?php echo $row['username']; ?>" disabled></td>
                </tr>
                <tr>
                    <td><label>No. Kad Pengenalan</label></td>
                    <td><input rows="5" cols="85" type="text" name="ic" value="<?php echo $row['admin_ic']; ?>" disabled></td>
                </tr>
                <tr>
                    <!--Changeable start from below-->
                    <td><label>Kedudukan/Pangkat</label></td>
                    <td><input size="100" type="text" name="position" value="<?php echo $row['position']; ?>" required>
    
                        <input type="submit" name="submit" value="KemasKini" id="reg_btn"></td>
                </tr>
            </table>
