                        ...
                        <div class="nav-header">
                            ...
                            <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li>
                                        ...
                                        <li><a class="active" href="reserve_history_residen.php">Sejarah Tempahan</a></li>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="reserve_history_residen.php" method="POST">
...
<!---------------------------------------button delete trigger---------------------------------------------->
                    <a  href="reserve_history_residen.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
...
<!-----------------------------------DELETE DATA----------------------------------------->
                <?php
                      ...
                      if(isset($_GET['delete'])){    
                        ...
                        echo "location = 'reserve_history_residen.php'";
                        echo "</script>";
