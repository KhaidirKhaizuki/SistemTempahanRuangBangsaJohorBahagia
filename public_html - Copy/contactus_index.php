				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="about_us.html">Mengenai Kami</a></li>
							<li><a class="active" href="contactus_index.php">Hubungi Kami</a></li>
...
<center>	<div id="fh5co-contact-section">
		<div class="row">
			<div class="col-md-6">
				<div class="col-md-12">
					...
					<ul class="contact-info">
						<li><i class="ti-map"></i>Kangkar Pulai, Johor Bharu, Johor Darul Takzim</li>
