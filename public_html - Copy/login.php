...
<body style="background-image: url(images/johor3.jpg); background-size: cover;" >
...
<header id="fh5co-header-section">
	<div class="container">
		<div class="nav-header">
			...
			<h1 id="fh5co-logo"><a style="color:black" href="index.php">Selamat Datang ke BJB</a></h1>
...
<form class="" action="login.php" method="POST">
	...
	<br><a href="forgot_pwd_form.php">Lupa Username/Kata Laluan</a>
	<br>
	<input type="submit" name="login" value="Log Masuk"><br>
	Cipta akaun baharu?<a href="signup.php"> Daftar Akaun</a>
	<br><br><br>
