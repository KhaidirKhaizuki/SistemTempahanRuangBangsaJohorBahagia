                ...
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="box_1">
                                <div class="form-field">
                                    <form action="portal_public.php" method="GET">
                    ...
                    if($num > 0){
                        ...
                        while($row=$result->fetch_assoc()){
                            ...
                            echo " <div>RM ".$row['price_public']." sehari </div>";
                            echo "<div> Blok ".$row['block']."</div>";
                            echo "<div>Kapasiti: ".$row['capacity']." orang </div>";?>

                                <div>
                                <a href="make_reservation_public.php?sid=<?php echo $row['space_id']; ?>" class="viewmore">Tempah</a>
                ...
                <div class="col-md-3">
                    <div class="copyright">
                        <p><small>&copy; 2020 Bangsa Johor Bahagia <br> All Rights Reserved. <br>
                                Designed<a href="http://unsplash.com/" target="_blank">Membertech</a> <br> Demo
