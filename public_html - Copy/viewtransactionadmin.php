			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Lihat Tempahan</h1>
					</div>
				</div>
			</div>
		</div>
...
if ($result->num_rows > 0) {
    echo "<table class='w3-table-all'><tr><th>ID</th><th>Rujukan</th><th>Fail</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" .$row['transaction_id']. "</td>";
        echo "<td>" .$row['rujukan']. "</td>";
     echo "<td><img src='" . $row["filepath"] . "' height='200' width='200' ></td>";
        echo "<td><a href='deletetransaction.php?id=".$row['transaction_id']."'>Delete</a></td>";
