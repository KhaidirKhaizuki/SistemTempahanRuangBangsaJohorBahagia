...
<body>
			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Permohonan Lupa Kata Laluan</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-services-section">
		<div class="container">
			<div class="row">
		<center>	
			<h5><a href=viewuser.php>Balik</a></h5>
                   <?php 
 $id = $_GET['id'];                  
//Open connection
...
$sql = "SELECT * FROM forgot WHERE forgotid = $id";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><th>ID</th>";
        echo "<td>" .$row['forgotid']. "</td>";
        echo "<tr><th>Email</th>";
         echo "<td>". "<a href='mailto:".$row['email']."'>".$row['email']."</a>". "</td>";
         echo "<tr><th>Status</th>";
        echo "<td>" .$row['status']. "</td>";
         echo "<tr><th>Tarikh Permohonan</th>";
        echo "<td>" .$row['date']. "</td>";
        echo "<tr><th>Buang???</th>";
        echo "<td><a href='deletepasswordreq.php?id=".$row['forgotid']."'>Delete</a></td>";
