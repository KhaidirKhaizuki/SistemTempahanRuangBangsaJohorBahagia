...
<body>
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <!-- end:fh5co-header -->
            <div class="fh5co-parallax" style="background-image: url(images/index_2.jpg);" data-stellar-background-ratio="0.5">
                ...
                <div class="col-sm-12">
                        ...
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="view_history_reserve_public.php" method="POST">
...
<div class="modal fade" id="exampleModal<?php echo $row['reserve_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <p>Tarikh bayaran<?php echo": ". $row['trans_date'].""; ?></p>
      <p>Masa bayaran<?php echo " : ". $row['trans_time'].""; ?></p>
      <p>Bukti          : <?php echo "<img src='".$row['filepath']."' height='350' width='100%'>";?></p>
...
<!---------------------------------------button delete trigger---------------------------------------------->
                    <a  href="view_history_reserve_public.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
...
<!-----------------------------------DELETE DATA----------------------------------------->
                <?php
                      ...
                      if(isset($_GET['delete'])){    
                        ...
                        echo "location = 'view_history_reserve_public.php'";
                        echo "</script>";
