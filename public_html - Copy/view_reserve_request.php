...
<body>
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <!-- end:fh5co-header -->
            <div class="fh5co-parallax" style="background-image: url(images/index_4.jpg);" data-stellar-background-ratio="0.5">
                ...
                <div class="col-sm-12">
                        ...
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="view_reserve_request.php" method="POST">
...
<!---------------------------------------button delete trigger---------------------------------------------->
                   <td>
                    <a  href="view_reserve_request_details.php?rid=<?php echo $row['reserve_id'];?>" 
                     >Lihat Tempahan</a>
