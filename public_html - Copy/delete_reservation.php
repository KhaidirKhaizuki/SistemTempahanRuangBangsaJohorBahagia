...
if (mysqli_query($conn, $sql)) {
    mysqli_close($conn);
    header('Location: view_reservation_admin.php'); //If book.php is your main page where you list your all records
    exit;
} else {
...
?>
      ...
      <div id="main">
  <form action="view_reservation_admin.php" align=left>
