...
<body>
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <!-- end:fh5co-header -->
            <div class="fh5co-parallax" style="background-image: url(images/index_1.jpg);" data-stellar-background-ratio="0.5">
            ...
            <div class="container">
                ...
                <div class="row">
                <div class="col-sm-12">
                        <h2>Senarai Tempahan Baru</h2>
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="view_reserve_request_resident.php" method="POST">
        ...
        if(isset($_POST['searchValue'])){    // Search activity
            ...
            if($num > 0){
                ...
                echo "<table class='table table-striped table-hover'>
                        <tr>
                            <th><font color=blue> Bil</font> </th>
                            <th><font color=blue> Ruang</font> </th>
                            <th><font color=blue> Tindakan</font> </th>
                        </tr>";
                $sr=1; 
...
<!---------------------------------------button delete trigger---------------------------------------------->
                   <td>
                    <a  href="view_reserve_request_details_res.php?rid=<?php echo $row['reserve_id'];?>" 
                     >Lihat Tempahan</a>
