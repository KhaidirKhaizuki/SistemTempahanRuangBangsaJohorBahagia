...
<body>
    <div id="fh5co-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        ...
                        <a href="view_reserve_request.php "target="blank"><img src="images\arrow.png" height="20px"></a>
     ...
     <td><?php echo $row2['block']; ?></td>
      ...
      <tr>
      <td><b>Harga </td>
        <td>RM <?php echo $row2['price_public']; ?></td>
      </tr>
      <tr>
      <td><b>Dari/Masa</td>
  ...
  <form action="view_reserve_request_details.php" method="POST" enctype="multipart/form-data">
 ...
 <!-- Buttons -->
       ...
       <div class="button-container">
                <div>
                    ...
                    <a href="view_reserve_request.php">
