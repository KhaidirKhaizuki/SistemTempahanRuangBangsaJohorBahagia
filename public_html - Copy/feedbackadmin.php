...
<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a  href="view_reservation_admin.php">Tempahan</a></li>
							
							<li>
								<a href="#" class="fh5co-sub-ddown">Tetapan</a>
								<ul class="fh5co-sub-menu">
								 	<li><a class="active" href="kk_admin">Profil</a></li>
			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Lihat Aduan</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-services-section">
		<div class="container">
			<div class="row">
			  <center><h5><a href=portal_admin.php>Balik</a></h5></center>
                   <?php 
//Open connection
...
if ($result->num_rows > 0) {
    echo "<table class='w3-table-all'><tr><th>Email</th><th>Pesanan</th><th>Masa</th></tr>";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td>" .$row['date']. "</td>";
        echo "<td><a onClick=\"javascript: return confirm('Anda pasti ingin buang ini?');\" href='deletefeedback.php?id=".$row['id']."'>Delete</a></td>";
