...
<head>
    ...
    <title>BJB &mdash; Sejarah Tempahan</title>
...
<body>
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <!-- end:fh5co-header -->
            <div class="fh5co-parallax" style="background-image: url(images/index_3.jpg);" data-stellar-background-ratio="0.5">
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="fh5co-intro fh5co-table-cell">
                                <h1 class="text-center">Residen</h1> <?php echo $_SESSION["email"]; ?> <br>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="box_1">
                                <div class="form-field">
                                    <form action="view_history_reserve_resident.php" method="POST">
                                        <input type="text" name="searchValue" placeholder="contoh: Nama...">
                                        <br><br>
   ...
   <!-----------------------------------VIEW DATA ------------------------------------->
    <?php
       ...
       if(isset($_POST['searchValue'])){    // Search activity
        ...
        s.name,s.block,s.price_resident,s.description,r.start_date,r.start_time,
...
<button type="button" class="edit" data-toggle="modal" data-target="#exampleModal<?php echo $row['reserve_id'];?>">
  Bukti
</button>

<!-- Modal -->
<div class="modal fade" id="exampleModal<?php echo $row['reserve_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <p> Tarikh : <?php echo $row['trans_date']; ?></p>
      <p> Masa : <?php echo $row['trans_time']; ?></p>
     <p> Bukti : <?php echo "<img src='".$row['filepath']."' height='250' width='250'>";?></p>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <p> Nama Pengguna<?php echo":<br>". $row['fullname'].""; ?></p>
       ...
       <p> Harga<?php echo        ":<br> RM ".$row['price_resident'].""; ?></p>
...
<!---------------------------------------button delete trigger---------------------------------------------->
                    <a  href="view_history_reserve_resident.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
...
<!-----------------------------------DELETE DATA----------------------------------------->
                <?php
                      ...
                      if(isset($_GET['delete'])){    
                        ...
                        echo "location = 'view_history_reserve_resident.php'";
                        echo "</script>";
