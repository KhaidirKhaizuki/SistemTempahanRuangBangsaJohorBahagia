        ...
        <div id="fh5co-page">
                        ...
                        <div class="nav-header">
							...
							<li><a  href="managespace.php">Ruang</a></li>
								...
								<ul class="fh5co-sub-menu">
								 	<li><a  href="reservation_admin_public.php">Orang Awam</a></li>
								 	<li><a class="active" href="reservation_admin_resident.php">Residen</a></li>
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="fh5co-intro fh5co-table-cell">
                                <h1 class="text-center">Tempahan</h1> <?php echo $_SESSION["email"]; ?> <br>
            ...
            <div class="container">
                ...
                <div class="col-sm-12">
                        ...
                        <form action="reservation_admin_resident.php" method="POST"> 
   <!-----------------------------------VIEW DATA ------------------------------------->
    <?php
        include_once("dbconfig.php");
     
        $sql2 ="SELECT r.reserve_id,r.fullname,r.telno,r.email, r.role, s.name,s.block,s.price_resident,s.description,r.start_date,r.start_time,r.end_date,r.end_time
        ...
        AND (r.role='resident')";
            ...
            if($num > 0){
                ...
                while($row=$result->fetch_assoc()){
                    ...
                    "<br />\n </b>" .$row['start_date'] . "\n" . 
                    "<br />\n </b>" .$row['start_time'] . "\n" . "</td>\n");
                    echo "<td><img src='".$row['filepath']."'></td>";?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p> Nama Pengguna: <?php echo $row['fullname']; ?></p>
       <p> No Telefon: <?php echo $row['telno']; ?></p>
       <p> Email: <?php echo $row['email']; ?></p>
       <p> Ruang: <?php echo $row['name']; ?></p>
       <p> Perbadanan: <?php echo $row['block']; ?></p>
       <p> Harga: RM <?php echo $row['price_resident']; ?></p>
       <p> Penerangan: <?php echo $row['description']; ?></p>
       <p> Dari: <?php echo $row['start_date']; ?></p>
       <p> Masa: <?php echo $row['start_time']; ?></p>
       <p> Hingga: <?php echo $row['end_date']; ?></p>
       <p> Masa: <?php echo $row['end_time']; ?></p>
...
<!---------------------------------------button delete trigger---------------------------------------------->
                    <a  href="reservation_admin_resident.php?delete=<?php echo $row['reserve_id'];?>" class ="padam" name ="delete" onclick="return confirm
                ...
                <?php
                     ...
                     if(isset($_GET['delete'])){    
                        ...
                        if ($query_run)
                       {
                        ...
                        echo "location = 'reservation_admin_resident.php'";
                        echo "</script>";
